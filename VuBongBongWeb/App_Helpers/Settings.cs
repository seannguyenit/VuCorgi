...
namespace VuBongBongWeb
{
    ...
    public static class Settings
    {
        ...
        /// <summary>
        ///     Retrieves the entry value for the following composed key: "config:FilePath" as a string.
        /// </summary>
        public static readonly string FilePath = GetValue<string>("FilePath");

        /// <summary>
        ///     Retrieves the entry value for the following composed key: "config:IsSyncSiteAndMenu" as a boolean.
        /// </summary>
        public static readonly bool IsSyncSiteAndMenu = GetValue<bool>("IsSyncSiteAndMenu");
        ...
        /// <returns></returns>
        public static T SetValue<T>(string key, string value, string prefix = Prefix)
        {
