        ...
        return this.each(function () {
            a(".superbox-list").click(function () {
                ...
                var d = $this.find(".superbox-img"),
                    e = d.data("img"),
                    f = d.data("description") || "No description",
                    g = e,
                    h = d.attr("title") || "No Title",
                    editL = d.data("editlink"),
                    deleteL = d.data("deletelink");
                c.attr("src", e), c.find(".btn-Edit").attr("href", editL), c.find(".btn-Delete").attr("href", deleteL), a(".superbox-list").removeClass("active"), $this.addClass("active"), c.find("em").text(g), c.find(">:first-child").text(h), c.find(".superbox-img-description").text(f), 0 == a(".superbox-current-img").css("opacity") && a(".superbox-current-img").animate({
                    "opacity": 1
